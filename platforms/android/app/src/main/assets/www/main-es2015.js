...
const routes = [
    ...
    {
        path: 'criar-evento',
        loadChildren: () => Promise.all(/*! import() | criar-evento-criar-evento-module */[__webpack_require__.e("common"), __webpack_require__.e("criar-evento-criar-evento-module")]).then(__webpack_require__.bind(null, /*! ./criar-evento/criar-evento.module */ "./src/app/criar-evento/criar-evento.module.ts")).then(m => m.CriarEventoPageModule)
    },
    {
        path: 'editar-evento/:id',
        loadChildren: () => Promise.all(/*! import() | editar-evento-editar-evento-module */[__webpack_require__.e("common"), __webpack_require__.e("editar-evento-editar-evento-module")]).then(__webpack_require__.bind(null, /*! ./editar-evento/editar-evento.module */ "./src/app/editar-evento/editar-evento.module.ts")).then(m => m.EditarEventoPageModule)
    },
    {
        path: 'chatbot',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./chatbot/chatbot.module */ "./src/app/chatbot/chatbot.module.ts")).then(m => m.ChatbotPageModule)
    },
    {
        path: 'login',
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _chatbot_chatbot_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chatbot/chatbot.module */ "./src/app/chatbot/chatbot.module.ts");
...
/* harmony import */ var _services_pusher_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./services/pusher.service */ "./src/app/services/pusher.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
        ...
        imports: [
            ...
            angularfire2__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig),
            ...
            _chatbot_chatbot_module__WEBPACK_IMPORTED_MODULE_1__["ChatbotPageModule"]
        ],
        providers: [
            ...
            _services_pusher_service__WEBPACK_IMPORTED_MODULE_19__["PusherService"],
            _services_chat_service__WEBPACK_IMPORTED_MODULE_20__["ChatService"],
...
/* harmony import */ var _chatbot_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chatbot-routing.module */ "./src/app/chatbot/chatbot-routing.module.ts");
/* harmony import */ var _chatbot_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chatbot.page */ "./src/app/chatbot/chatbot.page.ts");
...
ChatbotPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ...
            _chatbot_routing_module__WEBPACK_IMPORTED_MODULE_6__["ChatbotPageRoutingModule"]
        ],
...
let ChatbotPage = class ChatbotPage {
    ...
    ngOnInit() {
        this.mensagens = this.chat.conversation.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["scan"])((acc, val) => acc.concat(val)));
    }
    enviarMensagem() {
...
let AuthService = class AuthService {
    ...
    cadastro(value) {
        return new Promise((resolve, reject) => {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(value.email, value.senha)
                .then(res => resolve(res), err => reject(err));
        });
    }
    login(value) {
        return new Promise((resolve, reject) => {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithEmailAndPassword(value.email, value.senha)
                .then(res => resolve(res), err => reject(err));
        });
    }
    sair() {
...
class Mensagem {
    constructor(conteudo, enviadaPor) {
...
const environment = {
    ...
    firebaseConfig: {
        ...
        appId: '1:511985376129:web:69d26d52b2347f17c3a680'
        //  apiKey: 'AIzaSyBRKt8oj8zUkBla3_wGHNFKRgvaPsPXPZw',
...
module.exports = __webpack_require__(/*! /home/ascendant/Documentos/estudo/ionic/barber/src/main.ts */"./src/main.ts");
